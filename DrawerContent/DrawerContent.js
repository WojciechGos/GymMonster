...
const CustomDrawer = ({navigateToScreen}) =>{
    return (
        <View style={styles.drawerWrapper}>
            ...
            <DrawerListItem title='Statystyki' link='Statistic' handler={navigateToScreen} icon={<Fontisto name="line-chart" size={24}  color={colors.primary}  />}/>
            <DrawerListItem title='Osiągnięcia' link='Achievement' handler={navigateToScreen} icon={<MaterialCommunityIcons name="star" size={28} color={colors.primary}/>}/>
            ...
            <DrawerListItem title='Atlas ćwiczeń' link='ExerciseAtlas' handler={navigateToScreen} icon={<FontAwesome name="folder" size={24}  color={colors.primary} />}/>
            <DrawerListItem title='Zapisz postęp' link='ProgressForm' handler={navigateToScreen} icon={<MaterialIcons name="add-a-photo" size={24} color={colors.primary} />}/>
